...
public static class ChapterPrompts
{
    ...
    {
        return $@"Write Chapter {chapterNum} of ""The Second Son of the House of Bells.""
...
21. END the chapter differently from previous chapters. Do NOT end with Cass outside listening to his father work. Find the ending that belongs to THIS chapter specifically.
