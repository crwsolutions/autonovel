...
An autonomous pipeline for writing, revising, and typesetting a complete novel. From a seed concept to a print-ready PDF and ePub — all generated by AI agents.
...
### Phase 4: Export
Rebuild docs, typeset in LaTeX, generate PDF and ePub.
...
TYPESETTING:
  ...
  typeset/build_tex.py   — Chapters → LaTeX
...
The pipeline uses one external service:
